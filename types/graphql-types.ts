...
export type FileFieldsEnum = 
  ...
  'childMarkdownRemark___frontmatter___avatar_link' |
...
export type MarkdownRemarkFrontmatter = {
  ...
  avatar_link?: Maybe<Scalars['String']>,
};
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  avatar_link?: Maybe<StringQueryOperatorInput>,
};
...
export type TeamListQueryQueryVariables = {};


export type TeamListQueryQuery = { allMarkdownRemark: { nodes: Array<(
      Pick<MarkdownRemark, 'html'>
      & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'avatar_link' | 'name' | 'path' | 'roles' | 'title'>> }
    )> } };

export type MemberQueryByPathQueryVariables = {
  path?: Maybe<Scalars['String']>
};


export type MemberQueryByPathQuery = { markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'name' | 'roles' | 'avatar_link'>> }
  )> };
